     ...
     <Col lg="6" className="fade" id="photo-fadein">
         ...
         <Row size="mx-auto ml-lg-0" id="links">
             <Col size="col-12 pl-lg-0" id="subcol-links">
                 <div className="link" id="email"><a className="linkhref" href="mailto:xxxxxxxx@gmail.com" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faEnvelopeSquare} link /> xxxxxxx@gmail.com</a></div>
                 <div className="link" id="phone"><a className="linkhref" href="tell:0123456789" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={ faPhone } link /> 0123456789</a></div>
                 <div className="link" id="github-link"><a className="linkhref" href="https://github.com/Chib1co" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={ faGithubSquare } link /> Git hub page</a></div>
                 <div className="link" id="linkedin-link"><a className="linkhref" href="https://www.linkedin.com/in/tomomi-inoue-730ab71ab/" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faLinkedin} link /> Linkedin page</a></div>
                 <div className="link" id="resume"><a className="linkhref" href="assets/image/Resume.pdf" target="_blank" rel="noreferrer"><FontAwesomeIcon icont={faFile} link /> Resume (pdf file)</a></div>
